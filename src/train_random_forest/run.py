...
def go(args):
    ...
    with tempfile.TemporaryDirectory() as tmp:
        export_path = os.path.join(tmp, "random_forest_dir")
        logger.info(f"Saving model locally to {export_path} for upload to W&B later")
        ...
        # make sure the artifact is uploaded before we exit the context manager 
        # otherwise the folder may be deleted before the upload is complete
    ...
    logger.info("Uploading feature importance plot to W&B")
    run.log(
        {
